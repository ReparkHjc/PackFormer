...
parser.add_argument('--model_shuffle_filename', type=str, default="./RESU_params_tuner/model/")
parser.add_argument('--loss_filename', type=str, default="./RESU_params_tuner/loss/")
