...
class SE_VIT_Decoder(nn.Module):
    def __init__(self,type=1,cell_num=2,img_size=60,patch_size=2,in_c=3,embed_dim=500,
                     depth=4,num_heads=4,mlp_ratio=4,qkv_bias=False,attn_drop_ratio=0,
                     drop_path_ratio=0,norm_layer=None,act_layer=None,momentum=0.1, decoderFc_size=96, prediction_num=1):
