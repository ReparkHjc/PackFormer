...
path1 = './MIT_decoder_20_4/Model/' + Model + '/shuffle_False/' + str(train_radio) + '_params/STANDALONE_epoch_' + str(
    epoch) + '.params'
...
if Model == "VIT":
    model = SE_VIT_Decoder(type=1, embed_dim=500, attn_drop_ratio=0.4, prediction_num=1).cuda()
