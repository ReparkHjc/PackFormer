...
# path1 = "/home/lunet/ttpf/battery-package/nasa-master/nasa-master/RESU/RESU_params_tuner/model/u1oUs_epoch_950.params"
path1 = './RESU_decoder_20_4/Model/' + Model + '/shuffle_True/' + str(
    train_radio) + '_params/STANDALONE_epoch_800.params'
