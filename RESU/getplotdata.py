...
def plotdata(Model = "MLP"):
    ...
    if Model == "CNN_LSTM":
        ...
        path1 = './MIT_decoder_20_4/Model/CNN_LSTM/shuffle_True/0.8_params/STANDALONE_epoch_1500.params'
    elif Model == "MLP":
        model = MLP(cell_num=8, n_feature=10800, n_hidden=50, n_class=1).cuda()
        path1 = './MIT_decoder_20_4/Model/MLP/shuffle_True/0.8_params/STANDALONE_epoch_1950.params'
    elif Model == "CNN":
        model = CNN(cell_num=8, n_class=1).cuda()
        path1 = './MIT_decoder_20_4/Model/CNN/shuffle_True/0.8_params/STANDALONE_epoch_500.params'

    elif Model == "LSTM":
        model = LSTM(input_size=4320, hidden_dim=25, num_layers=3, n_class=1).cuda()
        path1 = './MIT_decoder_20_4/Model/LSTM/shuffle_True/0.8_params/STANDALONE_epoch_2250.params'
