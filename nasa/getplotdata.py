...
def plotdata(Model = "MLP"):
    ...
    if Model == "CNN_LSTM":
        ...
        path1 = './NASA_decoder3_attn0.5/Model/CNN_LSTM/shuffle_True/0.8_params/epoch_4650.params'
    elif Model == "MLP":
        model = MLP().cuda()

        path1 = './NASA_decoder3_attn0.5/Model/MLP/shuffle_True/0.8_params/epoch_150.params'
    elif Model == "CNN":
        model = CNN().cuda()
        path1 = './NASA_decoder3_attn0.5/Model/CNN/shuffle_True/0.8_params/epoch_150.params'

    elif Model == "LSTM":
        model = LSTM().cuda()
        path1 = './NASA_decoder3_attn0.5/Model/LSTM/shuffle_True/0.8_params/epoch_850.params'

    model.load_state_dict(torch.load(path1))

    train_dataloader, val_dataloader = train_val_dataset_sw2(SOH_path, data_path, Shuffle=False,
