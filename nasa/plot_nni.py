...
path1 = "/home/lunet/ttpf/battery-package/nasa-master/nasa-master/nasa/params_tuner/model/hiegE_epoch_800.params"
...
if Model == "VIT":
    model = SE_VIT_Decoder(type=1, embed_dim=200, attn_drop_ratio=0.5, prediction_num=1).cuda()
...
output_file1 = os.path.join(plot_data_dir, "VIT.csv")
