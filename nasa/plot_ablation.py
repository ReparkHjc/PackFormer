import torch
from VITNNi_nni import SE_VIT_Decoder
...
# path1 = "./ablation/model/STANDALONE_epoch_2300.params"
# type = 2

path1 = "./ablation/model/STANDALONE_epoch_500.params"
type = 4
...
if Model == "VIT":
    model = SE_VIT_Decoder(type=type, embed_dim=200, attn_drop_ratio=0.5, prediction_num=1).cuda()
...
train_dataloader, val_dataloader = train_val_dataset_sw2(SOH_path, data_path, Shuffle=False, Training_ratio=train_radio,
                                                         batch_size=6, row_pitch=6, sw_shape=20, num=180,
                                                         prediction_num=1)
...
# output_file1 = os.path.join(plot_data_dir, "VIT_ablation.csv")
