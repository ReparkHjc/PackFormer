...
parser.add_argument('--prediction_num', type=int, default=4)

# 数据路径
parser.add_argument('--data_dir', type=str, default="./data/5cell/data.csv")
parser.add_argument('--SOH_dir', type=str, default="./data/5cell/SOH.csv")
