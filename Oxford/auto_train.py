...
SOH_path = r"C:\Users\xzh\Desktop\SOH1\牛津\data\5cell\SOH.csv"
data_path = r"C:\Users\xzh\Desktop\SOH1\牛津\data\5cell\data.csv"
os.environ["CUDA_VISIBLE_DEVICES"] = "0"
root = r"C:\Users\xzh\Desktop\SOH2\niujin"
    ...
    for Shuffle in shuffle:
        ...
        for Train_num in train_num:
            ...
            if isinstance(Model, str):
                if Model == "VIT":
                    model = SE_VIT_Decoder(type=3, embed_dim=500, attn_drop_ratio=0.5, prediction_num=1).cuda()
            ...
            if Model == "MLP":
                model = MLP(cell_num=cell_num, n_feature=10800, n_hidden=33, n_class=1).cuda()
