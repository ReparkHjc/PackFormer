...
data_path= "/home/zhihao/MIT_params_tuner/data_mit/10/data_10.csv"
SOH_path="/home/zhihao/MIT_params_tuner/data_mit/10/SOH_10.csv"


os.environ["CUDA_VISIBLE_DEVICES"] = "0"
root = "/home/zhihao/SOH/MIT_SW/10_atten0.5"
    ...
    for Shuffle in shuffle:
        ...
        for Train_num in train_num:
            ...
            train_main(learning_rate=1e-4, SOH_path=SOH_path, data_path=data_path, epoch=5500,
                       ...
                       Shuffle=Shuffle, patch_size=2, batch_size=6, sw_size=10, prediction_num=1)
