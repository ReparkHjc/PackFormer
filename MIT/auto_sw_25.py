...
data_path= "/home/zhihao/MIT_params_tuner/data_mit/25/data_25.csv"
SOH_path="/home/zhihao/MIT_params_tuner/data_mit/25/SOH_25.csv"


os.environ["CUDA_VISIBLE_DEVICES"] = "0"
root = "/home/zhihao/SOH/MIT_SW/25_atten0.5"
    ...
    for Shuffle in shuffle:
        ...
        for Train_num in train_num:
            ...
            train_main(learning_rate=1e-4, SOH_path=SOH_path, data_path=data_path, epoch=5500,
                       ...
                       Shuffle=Shuffle, patch_size=2, batch_size=6, sw_size=25, prediction_num=1)
