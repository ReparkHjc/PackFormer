...
path1 = "/home/lunet/ttpf/battery-package/nasa-master/nasa-master/MIT/MIT_params_tuner/model/aif0p_250_0.00022128691526396088.params"
...
if Model == "VIT":
    model = SE_VIT_Decoder(type=1, embed_dim=1024, attn_drop_ratio=0.3, prediction_num=1).cuda()
