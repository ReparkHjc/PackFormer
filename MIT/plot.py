...
#
# path1 = './MIT_decoder_20_4/Model/' + Model + '/shuffle_True/' + str(train_radio) + '_params/epoch_' + str(
#     epoch) + '.params'
...
def data(model):
    ...
    # print(label_val.shape, predict_val.shape,label_train.shape, predict_train.shape)
