...
def plotdata(Model = "MLP"):
    ...
    if Model == "CNN_LSTM":
        ...
        path1 = './MIT_decoder_20_4/Model/CNN_LSTM/shuffle_True/0.8_params/epoch_150.params'
    elif Model == "MLP":
        model = MLP(cell_num=2, n_feature=10800, n_hidden=50, n_class=4).cuda()
        path1 = './MIT_decoder_20_4/Model/MLP/shuffle_True/0.8_params/epoch_50.params'
    elif Model == "CNN":
        model = CNN(cell_num=2, n_class=4).cuda()
        path1 = './MIT_decoder_20_4/Model/CNN/shuffle_True/0.8_params/epoch_300.params'

    elif Model == "LSTM":
        model = LSTM(input_size=1080, hidden_dim=25, num_layers=3, n_class=4).cuda()
        path1 = './MIT_decoder_20_4/Model/LSTM/shuffle_True/0.8_params/epoch_50.params'
